...
class WeeklyWeatherClass: UIViewController {
    ...
    func weeklyData() {
        ...
        self.forecast1String = days1["conditions"] as NSString
        ...
        self.precip1String = "Chance of Rain: " + rainIsWeird111 + "%"
        ...
        self.time2String = date2["weekday"] as NSString
        self.time2Label.text = self.time2String
        self.forecast2String = days2["conditions"] as NSString
        ...
        self.precip2String = "Chance of Rain: " + rainIsWeird222 + "%"
        ...
        self.time3String = date3["weekday"] as NSString
        self.time3Label.text = self.time3String
        self.forecast3String = days3["conditions"] as NSString
        ...
        self.precip3String = "Chance of Rain: " + rainIsWeird333 + "%"
        ...
        self.time4String = date4["weekday"] as NSString
        self.time4Label.text = self.time4String
        self.forecast4String = days4["conditions"] as NSString
        ...
        self.precip4String = "Chance of Rain: " + rainIsWeird444 + "%"
        ...
        self.time5String = date5["weekday"] as NSString
        self.time5Label.text = self.time5String
        self.forecast5String = days5["conditions"] as NSString
        ...
        self.precip5String = "Chance of Rain: " + rainIsWeird555 + "%"
